        ...
        if ($form->isSubmitted()) {
            if($form->isValid()){
                ...
                //$usuario->setTelefono($data['telefono']);
                    ...
                    $usuario->setSucursal($data['sucursal']);
                ...
                //$usuario->setCelular($data['celular']);
                    ...
                    $this->get('send_mail')->send('info@plataforma-er.com',array('info@empresaresponsable.org','leolivera@empresaresponsable.org','cricardez@red-erac.com'),'Empresa Responsable - Nuevo Registro',$this->renderView('@Frontend/Default/mail/registro.html.twig',array('registro'=>$usuario)),null);
                    if($nivel->getId()==2){
